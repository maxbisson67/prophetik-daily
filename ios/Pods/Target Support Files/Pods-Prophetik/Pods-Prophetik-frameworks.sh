...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RNFBFunctions/RNFBFunctions.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RNPurchases/RNPurchases.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RNWorklets/RNWorklets.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/React-RCTFBReactNativeSpec/React_RCTFBReactNativeSpec.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/React-runtimeexecutor/React_runtimeexecutor.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SDWebImageAVIFCoder/SDWebImageAVIFCoder.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/libavif/libavif.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/libdav1d/libdav1d.framework"
